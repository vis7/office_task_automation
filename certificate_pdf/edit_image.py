    ...
    for i in range(2,2000):
        ...
        if date:
            ...
            if name and subject and date and email:
                ...
                completion_letter_template_path = os.path.join(abs_path_of_directory, "certificate_pdf", "data", "completion_letter_template.jpg")
                img = Image.open(completion_letter_template_path)
                image_ed = ImageDraw.Draw(img)
                ...
                # image_ed.text(duration_position, duration, color, font=font)
                certificate_path = os.path.join(abs_path_of_directory, 'certificate_pdf', 'completion_letter', f'{name}_completion_letter.jpeg')
